...
<div>
    <div>
        ...
        <footer class="footer">
            Made with 🎸 from <a href="https://twitter.com/wisdomaebong" target="_blank">webong </a> 
            This project is open source, visit 
            <a href="https://github.com/webong/livewire-eshop" target="_blank">the repo </a> 
            and star it.
            Template based on <a href="https://github.com/sdras/sample-vue-shop" target="_blank">sample vue shop </a> made by <a href="https://twitter.com/sarah_edo" target="_blank">sarah_edo</a>.
        </footer>
    </div>
</div>
